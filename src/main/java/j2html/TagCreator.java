...
import j2html.tags.*;
import static j2html.tags.InlineStatic.*;
...
public class TagCreator {
    ...
    public static ContainerTag inlineCss(String path)       { return getInlineResource(path, "css"); }
    public static ContainerTag inlineJs(String path)        { return getInlineResource(path, "js"); }

    public static ContainerTag inlineCssMin(String path)    { return getInlineResource(path, "css.min"); }
    public static ContainerTag inlineJsMin(String path)     { return getInlineResource(path, "js.min"); }
