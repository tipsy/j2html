...
public class EmptyTag extends Tag {
    ...
    public EmptyTag withAlt(String alt) {
        return attr(Attr.ALT, alt);
    }

    public EmptyTag withAction(String action) {
    ...
    public EmptyTag withHref(String href) {
    ...
    public EmptyTag withData(String dataAttr, String value) {
        return attr(Attr.DATA + "-" + dataAttr, value);
    }

    public EmptyTag withMethod(String method) {
    ...
    public EmptyTag withPlaceholder(String placeholder) {
        return attr(Attr.PLACEHOLDER, placeholder);
    }

    public EmptyTag withType(String type) {
        return attr(Attr.TYPE, type);
    }

    public EmptyTag withRel(String rel) {
        return attr(Attr.REL, rel);
    }

    public EmptyTag withSrc(String src) {
        return attr(Attr.SRC, src);
    }

    public EmptyTag withValue(String value) {
