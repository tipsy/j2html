...
public class TagTest {
  ...
  public void testRender() throws Exception {
    ...
    String expectedResult =
        "<html><body><header></header><main><p>Main stuff...</p></main><footer><p>Conditional with!</p></footer></body></html>";
  ...
  public void testFormattedTags() throws Exception { // better test in ComplexRenderTest.java
    assertThat(
        div(p("Hello")).renderFormatted(), is("<div>\n    <p>\n        Hello\n    </p>\n</div>\n"));
  }
  ...
  public void testAcceptObjectValueAttribute() throws Exception {
    ContainerTag complexTestTag =
        new ContainerTag("input").attr("attr1", "value1").attr("attr2", 2).attr("attr3", null);
  ...
  public void testDynamicAttributeReplacement() throws Exception {
    ContainerTag testTagWithAttrValueNull =
        new ContainerTag("a").attr("href", "/link").attr(new DynamicHrefAttribute());
    assertThat(testTagWithAttrValueNull.render(), is("<a href=\"/\"></a>"));
  }
}
