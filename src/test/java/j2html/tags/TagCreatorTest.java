...
public class TagCreatorTest {
  ...
  private static final String EOL =
      System.getProperty("line.separator"); // System independent End Of Line

  List<Employee> employees =
      Arrays.asList(
          new Employee(1, "Name 1", "Title 1"),
          new Employee(2, "Name 2", "Title 2"),
          new Employee(3, "Name 3", "Title 3"));
  ...
  public void testIff() throws Exception {
    ...
    String actual =
        div(p("Test"), iff(1 == 1, a("Test").withHref("#")), iff(1 == 2, a("Tast").withHref("#")))
            .render();
  ...
  public void testJoin() throws Exception {
    String expected =
        "This is my joined string. It has a <a href=\"#\">link in the middle</a> and <code>code at the end</code>.";
    String actual =
        join(
                "This is my joined string. It has a",
                a("link in the middle").withHref("#"),
                "and",
  ...
  public void testEach() throws Exception {
    String j2htmlMap =
        ul().with(
                li("Begin list"),
                each(employees, employee -> li(h2(employee.name), p(employee.title))))
            .render();
    String javaMap =
        ul().with(
                li("Begin list"),
                rawHtml(
                    employees
                        .stream()
                        .map(employee -> li(h2(employee.name), p(employee.title)))
    ...
    assertThat(
        j2htmlMap,
        is(
            "<ul><li>Begin list</li><li><h2>Name 1</h2><p>Title 1</p></li><li><h2>Name 2</h2><p>Title 2</p></li><li><h2>Name 3</h2><p>Title 3</p></li></ul>"));
  }
  ...
  public void testFilter() throws Exception {
    String j2htmlFilter =
        ul().with(
                li("Begin list"),
                each(
                    filter(employees, e -> e.id % 2 == 1),
                    employee -> li(h2(employee.name), p(employee.title))))
            .render();
    String javaFilter =
        ul().with(
                li("Begin list"),
    ...
    assertThat(
        j2htmlFilter,
        is(
            "<ul><li>Begin list</li><li><h2>Name 1</h2><p>Title 1</p></li><li><h2>Name 3</h2><p>Title 3</p></li></ul>"));
  }
  ...
  public void testAllTags() throws Exception {
    ...
    assertThat(
        text("<script> and \"</script>\"").render(),
        is("&lt;script&gt; and &quot;&lt;/script&gt;&quot;"));
